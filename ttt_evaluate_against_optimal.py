...
class EvaluateAgainstOptimal:
    def __init__(self):
        ...
        """
        optimal_policy_path = os.path.dirname(
            os.getcwd()) + '/optimal_policy.pkl'
    ...
    def Run(self):
        ...
        print("%i ties and %i losses against optimal policy, playing X." %
              (result_as_x.count(0), result_as_x.count(-1)))
        ...
        print("%i ties and %i losses against optimal policy, playing O." %
              (result_as_o.count(0), result_as_o.count(1)))
